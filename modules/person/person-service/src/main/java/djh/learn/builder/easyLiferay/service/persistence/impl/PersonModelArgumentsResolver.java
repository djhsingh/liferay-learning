...
/**
 * The arguments resolver class for retrieving value from Person.
 *
...
@Component(
	immediate = true,
	service = {PersonModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class PersonModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getTableName() {
		return PersonTable.INSTANCE.getTableName();
	}
	...
	static {
		...
		orderByColumnsBitmask |= PersonModelImpl.getColumnBitmask("age");
