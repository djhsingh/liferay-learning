 ...
 * @generated
 */
public abstract class PersonFinderBaseImpl extends BasePersistenceImpl<Person> {

	public PersonFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return personPersistence.getBadColumnNames();
	}
