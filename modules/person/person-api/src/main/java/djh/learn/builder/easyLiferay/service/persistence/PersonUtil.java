...
public class PersonUtil {
	 ...
	 * @return the matching persons
	 */
	public static List<Person> findByMarried(boolean married) {
		return getPersistence().findByMarried(married);
	}
	 ...
	 * @return the range of matching persons
	 */
	public static List<Person> findByMarried(
		boolean married, int start, int end) {

		return getPersistence().findByMarried(married, start, end);
	}
	...
	public static List<Person> findByMarried(
		...
		return getPersistence().findByMarried(
			married, start, end, orderByComparator);
	}
	...
	public static List<Person> findByMarried(
		...
		return getPersistence().findByMarried(
			married, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchPersonException if a matching person could not be found
	 */
	public static Person findByMarried_First(
			boolean married, OrderByComparator<Person> orderByComparator)
		throws djh.learn.builder.easyLiferay.exception.NoSuchPersonException {

		return getPersistence().findByMarried_First(married, orderByComparator);
	}
	 ...
	 * @return the first matching person, or <code>null</code> if a matching person could not be found
	 */
	public static Person fetchByMarried_First(
		boolean married, OrderByComparator<Person> orderByComparator) {

		return getPersistence().fetchByMarried_First(
			married, orderByComparator);
	}
	 ...
	 * @throws NoSuchPersonException if a matching person could not be found
	 */
	public static Person findByMarried_Last(
			boolean married, OrderByComparator<Person> orderByComparator)
		throws djh.learn.builder.easyLiferay.exception.NoSuchPersonException {

		return getPersistence().findByMarried_Last(married, orderByComparator);
	}
	 ...
	 * @return the last matching person, or <code>null</code> if a matching person could not be found
	 */
	public static Person fetchByMarried_Last(
		boolean married, OrderByComparator<Person> orderByComparator) {

		return getPersistence().fetchByMarried_Last(married, orderByComparator);
	}
	 ...
	 * @throws NoSuchPersonException if a person with the primary key could not be found
	 */
	public static Person[] findByMarried_PrevAndNext(
			long personId, boolean married,
			OrderByComparator<Person> orderByComparator)
		throws djh.learn.builder.easyLiferay.exception.NoSuchPersonException {

		return getPersistence().findByMarried_PrevAndNext(
			personId, married, orderByComparator);
	}
	 ...
	 * @param married the married
	 */
	public static void removeByMarried(boolean married) {
		getPersistence().removeByMarried(married);
	}
	 ...
	 * @return the number of matching persons
	 */
	public static int countByMarried(boolean married) {
		return getPersistence().countByMarried(married);
	}
