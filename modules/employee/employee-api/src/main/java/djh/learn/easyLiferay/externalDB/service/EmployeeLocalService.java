...
public interface EmployeeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>djh.learn.easyLiferay.externalDB.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Employee createEmployee(
			ServiceContext serviceContext, String name, double salary, Date dob)
	...
	public Employee updateEmployee(
			long employeeId, String name, Date dob, double salary)
		throws PortalException;
