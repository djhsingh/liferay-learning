...
package djh.learn.easyLiferay.externalDB.service.persistence.impl;
...
import djh.learn.easyLiferay.externalDB.model.EmployeeTable;
import djh.learn.easyLiferay.externalDB.model.impl.EmployeeImpl;
import djh.learn.easyLiferay.externalDB.model.impl.EmployeeModelImpl;
import djh.learn.easyLiferay.externalDB.service.persistence.EmployeePersistence;
import djh.learn.easyLiferay.externalDB.service.persistence.EmployeeUtil;
...
public class EmployeePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByBySalary;
	private FinderPath _finderPathWithoutPaginationFindByBySalary;
	private FinderPath _finderPathCountByBySalary;

	/**
	 * Returns all the employees where salary = &#63;.
	 *
	 * @param salary the salary
	 * @return the matching employees
	 */
	@Override
	public List<Employee> findByBySalary(double salary) {
		return findByBySalary(
			salary, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the employees where salary = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Employee> findByBySalary(double salary, int start, int end) {
		return findByBySalary(salary, start, end, null);
	}

	/**
	 * Returns an ordered range of all the employees where salary = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Employee> findByBySalary(
		double salary, int start, int end,
		OrderByComparator<Employee> orderByComparator) {

		return findByBySalary(salary, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByBySalary(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByBySalary;
				finderArgs = new Object[] {salary};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByBySalary;
			finderArgs = new Object[] {salary, start, end, orderByComparator};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_BYSALARY_SALARY_2);
	...
	/**
	 * Returns the first employee in the ordered set where salary = &#63;.
	 *
	 * @param salary the salary
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching employee
	 ...
	 */
	@Override
	public Employee findByBySalary_First(
			double salary, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByBySalary_First(salary, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByBySalary_First(
		double salary, OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findByBySalary(salary, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last employee in the ordered set where salary = &#63;.
	 *
	 * @param salary the salary
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching employee
	 ...
	 */
	@Override
	public Employee findByBySalary_Last(
			double salary, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByBySalary_Last(salary, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByBySalary_Last(
		double salary, OrderByComparator<Employee> orderByComparator) {

		int count = countByBySalary(salary);

		if (count == 0) {
			return null;
		}

		List<Employee> list = findByBySalary(
			salary, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the employees before and after the current employee in the ordered set where salary = &#63;.
	 *
	 * @param employeeId the primary key of the current employee
	 * @param salary the salary
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Employee[] findByBySalary_PrevAndNext(
			long employeeId, double salary,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
		...
		try {
			...
			array[0] = getByBySalary_PrevAndNext(
				session, employee, salary, orderByComparator, true);

			array[1] = employee;

			array[2] = getByBySalary_PrevAndNext(
				session, employee, salary, orderByComparator, false);
	...
	protected Employee getByBySalary_PrevAndNext(
		Session session, Employee employee, double salary,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the employees where salary = &#63; from the database.
	 *
	 * @param salary the salary
	 */
	@Override
	public void removeByBySalary(double salary) {
		for (Employee employee :
				findByBySalary(
					salary, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of employees where salary = &#63;.
	 *
	 * @param salary the salary
	 * @return the number of matching employees
	 */
	@Override
	public int countByBySalary(double salary) {
		FinderPath finderPath = _finderPathCountByBySalary;

		Object[] finderArgs = new Object[] {salary};
	...
	private static final String _FINDER_COLUMN_BYSALARY_SALARY_2 =
		"employee.salary = ?";
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByBySalary = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByBySalary",
			new String[] {
				Double.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"salary"}, true);

		_finderPathWithoutPaginationFindByBySalary = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByBySalary",
			new String[] {Double.class.getName()}, new String[] {"salary"},
			true);

		_finderPathCountByBySalary = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByBySalary",
			new String[] {Double.class.getName()}, new String[] {"salary"},
			false);
