...
import djh.learn.easyLiferay.externalDB.model.EmployeeModel;
...
public class EmployeeModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"name", Types.VARCHAR}, {"salary", Types.DOUBLE},
		{"dob", Types.TIMESTAMP}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table Employee (uuid_ VARCHAR(75) null,employeeId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,salary DOUBLE,dob DATE null)";

	public static final String TABLE_SQL_DROP = "drop table Employee";

	public static final String ORDER_BY_JPQL = " ORDER BY employee.salary ASC";

	public static final String ORDER_BY_SQL = " ORDER BY Employee.salary ASC";
	 ...
	 */
	@Deprecated
	public static final long SALARY_COLUMN_BITMASK = 4L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		djh.learn.easyLiferay.externalDB.service.util.ServiceProps.get(
			"lock.expiration.time.djh.learn.easyLiferay.externalDB.model.Employee"));
	...
	public double getOriginalSalary() {
		return GetterUtil.getDouble(
			this.<Double>getColumnOriginalValue("salary"));
	}
	...
	public int compareTo(Employee employee) {
		...
		else if (getSalary() > employee.getSalary()) {
			value = 1;
		}
		else {
			value = 0;
